...
def new_setup_data():
    ...
    Category.product_count = sum(product.quantity for product in category1._Category__products) + \
                             sum(product.quantity for product in category2._Category__products)
